...
def Create_sheets_per_subject():
    ...
    for value in distinct_values['SubjectId']:
        ...
        selected_rows.to_excel(
            f"Subjects_Sheets/Grade_{GradeId2}/Language Type_{LanguageType2}/{subjectName2}_Id_{value}.xlsx",
            index=False)

        print(
            "Created:" + f"Subjects_Sheets/Grade_{GradeId2}/Language Type_{LanguageType2}/{subjectName2}_Id_{value}.xlsx")
        # print(subjectName)
...
tabControl.add(tab3, text='Fill Exams Sheet')
...
Create_Subjects_Sheet_label = tkinter.Label(tab3, text="After creating Exams sheet, Click Start to Create sheet for each subject\n please note that process will complete when progress bar stops loading")
